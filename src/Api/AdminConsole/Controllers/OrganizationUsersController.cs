...
public class OrganizationUsersController : Controller
{
    ...
    [HttpGet("")]
    public async Task<ListResponseModel<OrganizationUserUserDetailsResponseModel>> Get(Guid orgId, bool includeGroups = false, bool includeCollections = false, bool includeTwoFactorProvidersEnabled = false)
    {
        ...
        var organizationUsers = await _organizationUserRepository.GetManyDetailsByOrganizationAsync(orgId, includeGroups, includeCollections, includeTwoFactorProvidersEnabled);
