...
public class StripePaymentServiceTests
{
    ...
    {
        var plans = StaticStore.Plans.Where(p => p.Type == PlanType.BravuraEnterprise).ToList();
    ...
    {
        var plans = StaticStore.PasswordManagerPlans.Where(p => p.Type == PlanType.BravuraEnterprise).ToList();
    ...
    {
        var plan = StaticStore.Plans.Where(p => p.Type == PlanType.BravuraEnterprise).ToList();
        paymentToken = "pm_" + paymentToken;
