IF COL_LENGTH('[dbo].[OrganizationUser]', 'ForcePasswordReset') IS NULL
BEGIN
    ALTER TABLE
        [dbo].[OrganizationUser]
    ADD
        [ForcePasswordReset] BIT NOT NULL DEFAULT (1)
END
GO
...
BEGIN
    ...
    SET
        ...
        [ForcePasswordReset] = OUI.[ForcePasswordReset]
    FROM
...
IF TYPE_ID(N'[dbo].[OrganizationUserType2]') IS NOT NULL
BEGIN
...
IF OBJECT_ID('[dbo].[OrganizationUserUserDetailsView]') IS NOT NULL
BEGIN
    EXECUTE sp_refreshsqlmodule N'[dbo].[OrganizationUserUserDetailsView]';
END
GO
...
CREATE OR ALTER VIEW [dbo].[OrganizationUserView]
AS
SELECT
    *
FROM
